...
public class Uye {
   ...
   //Decdate ->hakkkında
    ...
    public static ObservableList<Uye> searchPersons(String isim, String ad, String soyad, String uni, String ikametgah, String kayitno, String kayittarihi, String durum) throws ClassNotFoundException, SQLException {

        String selectStmt = "SELECT * FROM kayitlar WHERE ";
        String yenisi = "";
        if(!isim.isEmpty()) {
            yenisi += "isim LIKE '%"+isim+"%'";
        }
        if(!ad.isEmpty()) {
            if(!yenisi.isEmpty()) yenisi += " AND ";
